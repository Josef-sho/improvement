...
export function GlowingStarsTeam() {
    return (
        <>
            ...
            <div id="team" className="flex justify-center items-center min-h-screen w-full mx-auto bg-gray-100 dark:bg-black">
                <div className="grid grid-cols-1 gap-4 md:gap-12 md:grid-cols-2 mx-auto py-20 bg-white dark:bg-black antialiased w-[90%]">
                    <a href="https://www.linkedin.com/in/jaideloje/" target="blank" className="col-span-2 md:col-span-1">
                    ...
                    <a href="https://www.linkedin.com/in/system625/" target="blank" className="col-span-2 md:col-span-1">
                    ...
                    <a href="https://www.linkedin.com/in/joseph-shodunke/" target="blank" className="col-span-2 md:col-span-1">
                    ...
                    <a href="https://www.linkedin.com/in/israelademola/" target="blank" className="col-span-2 md:col-span-1">
                    ...
                    <a href="https://www.linkedin.com/in/israelademola/" target="blank" className="col-span-2">
